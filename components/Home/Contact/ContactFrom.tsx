    ...
    return (
        <div className="bg-[#140c1c] rounded-lg p-4 sm:p-10">
            ...
            <p className="text-gray-200 mt-3 lg:text-base text-xs md:text-sm">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quisquam dolores blanditiis possimus, in architecto esse.
            </p>
            {/* input fields */}
            <form className="mt-8 block w-full overflow-hidden">
                ...
                <div className="mt-4">
                    <button className="px-8 py-3.5 bg-[#7947df] text-white hover:bg-[#5c2fb7] transition-all rounded-full">Send Message</button>
                </div>
            </form>
        </div>
    );
