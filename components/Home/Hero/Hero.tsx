...
const Hero = () => {
    return (
        <div className="w-full pt-[4vh] mb:pt-[12vh] h-screen bg-[#0f0715] overflow-hidden relative">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
                    ...
                    <div>
                        ...
                        <h1 data-aos="fade-left"
                            className="text-2xl md:text-3xl lg:text-4xl mb-5 text-gray-300 font-semibold">I am {BaseInfo.name}</h1>
                        {/* Title */}
                        <h2 data-aos="fade-right" data-aos-delay="100" className="text-bg text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[4rem] text-white ">{BaseInfo.position}</h2>
                        {/* Description */}
